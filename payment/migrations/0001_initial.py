# Generated by Django 4.2.6 on 2024-03-16 16:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bedding_store', '0004_profile_old_cart'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bedding_store.product')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
